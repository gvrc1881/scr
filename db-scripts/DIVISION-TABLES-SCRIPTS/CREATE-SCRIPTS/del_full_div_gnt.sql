...
CREATE TABLE gnt.allocation_del
(
  ...
  CONSTRAINT pk_allocation_del PRIMARY KEY (allocation_code)
);
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_uom_type_del PRIMARY KEY (uom_type_id)
);
...
CREATE TABLE gnt.inventory_item_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_inventory_item_type_del PRIMARY KEY (inventory_item_type_id)
);
...
(
  ...
  CONSTRAINT pk_uom_del PRIMARY KEY (uom_id)
);
-- Table: gnt.uom_conversion

-- DROP TABLE gnt.uom_conversion;

CREATE TABLE gnt.uom_conversion_del
(
  uom_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_uom_conversion_del PRIMARY KEY (uom_id, uom_id_to)
);
...
CREATE TABLE gnt.facility_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_facility_type_del PRIMARY KEY (facility_type_id),
  CONSTRAINT facility_typepar FOREIGN KEY (parent_type_id)
      REFERENCES gnt.facility_type_del (facility_type_id) MATCH SIMPLE
...
--  default_dimension_uom_id character varying(20),
 ...
 -- organized character varying(20),
  ...
  CONSTRAINT pk_facility_del PRIMARY KEY (facility_id),
  CONSTRAINT fac_def_uom_del FOREIGN KEY (default_weight_uom_id)
      REFERENCES gnt.uom_del (uom_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fac_invitm_type_del FOREIGN KEY (default_inventory_item_type_id)
      REFERENCES gnt.inventory_item_type_del (inventory_item_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT facility_fctyp_del FOREIGN KEY (facility_type_id)
      REFERENCES gnt.facility_type_del (facility_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
 ...
 --     ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT facility_parent_del FOREIGN KEY (parent_facility_id)
      REFERENCES gnt.facility_del (facility_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
...
CREATE TABLE gnt.app_device_del
(
  ...
  CONSTRAINT pk_app_device_del PRIMARY KEY (seq_id)
);
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_del PRIMARY KEY (party_id)
);
...
CREATE TABLE gnt.user_login_del
(
  ...
  CONSTRAINT pk_user_login_del PRIMARY KEY (user_login_id)
);
...
CREATE TABLE gnt.user_login_history_del
(
  user_login_id character varying(255) NOT NULL,
  ...
  created_tx_stamp timestamp with time zone,
  party_id character varying(20),
  CONSTRAINT pk_user_login_history_del PRIMARY KEY (user_login_id, from_date)
);
...
CREATE TABLE gnt.app_device_login_del
(
  seq_id character varying(20) NOT NULL,
  app_name character varying(100),
  device_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_app_device_login_del PRIMARY KEY (seq_id),
  CONSTRAINT app_device_usrlog FOREIGN KEY (user_login_id)
      REFERENCES gnt.user_login_del (user_login_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.app_device_unit_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_app_device_unit_del PRIMARY KEY (seq_id),
  CONSTRAINT app_device_unit_seqid FOREIGN KEY (app_device_seq_id)
      REFERENCES gnt.app_device_del (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE gnt.asset_make_model_assoc_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_make_model_assoc_del PRIMARY KEY (asset_type, make_code)
);
...
CREATE TABLE gnt.work_effort_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_work_effort_type_del PRIMARY KEY (work_effort_type_id)
);
...
CREATE TABLE gnt.telecom_number_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_telecom_number_del PRIMARY KEY (contact_mech_id)
);
...
CREATE TABLE gnt.structure_type_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_structure_type_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.status_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_status_type_del PRIMARY KEY (status_type_id)
);
...
CREATE TABLE gnt.status_item_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_status_item_del PRIMARY KEY (status_id)
);
...
CREATE TABLE gnt.status_valid_change_del
(
  status_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_status_valid_change_del PRIMARY KEY (status_id, status_id_to)
);
...
CREATE TABLE gnt.role_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_role_type_del PRIMARY KEY (role_type_id)
);
...
CREATE TABLE gnt.requirement_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_requirement_type_del PRIMARY KEY (requirement_type_id)
) ;
...
CREATE TABLE gnt.psi_report_registry_del
(
  ...
  CONSTRAINT pk_psi_report_registry_del PRIMARY KEY (report_id)
);
...
CREATE TABLE gnt.report_group_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_report_group_del PRIMARY KEY (report_group_id)
);
...
CREATE TABLE gnt.report_registry_del
(
  report_id character varying(20) NOT NULL,
  ...
  report_header text,
  report_code character varying(100),
  CONSTRAINT pk_report_registry_del PRIMARY KEY (report_id)
);
...
CREATE TABLE gnt.report_group_member_del
(
  report_group_id character varying(20) NOT NULL,
  report_id character varying(20) NOT NULL,
  sequence_num numeric(20,0),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_report_group_member_del PRIMARY KEY (report_group_id, report_id)
);
...
CREATE TABLE gnt.product_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_product_type_del PRIMARY KEY (product_type_id)
);
 ...
 */
  ...
  auto_delate_keywords character(1),
...
--  release_date timestamp with time zone,
  ...
  CONSTRAINT pk_product_del PRIMARY KEY (product_id)
);
...
CREATE TABLE gnt.product_category_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_product_category_type_del PRIMARY KEY (product_category_type_id)
);
...
CREATE TABLE gnt.product_category_del
(
...
*/
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_product_category_del PRIMARY KEY (product_category_id)
);
...
CREATE TABLE gnt.product_category_member_del
(
  product_category_id character varying(20) NOT NULL,
  product_id character varying(20) NOT NULL,
  from_date timestamp with time zone NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_product_category_member_del PRIMARY KEY (product_category_id, product_id, from_date)
);
...
CREATE TABLE gnt.priority_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_priority_type_del PRIMARY KEY (priority_type_id)
);
...
CREATE TABLE gnt.period_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_period_type_del PRIMARY KEY (period_type_id)
);
...
CREATE TABLE gnt.party_status_del
(
  status_id character varying(20) NOT NULL,
  party_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_status_del PRIMARY KEY (status_id, party_id, status_date)
);
...
CREATE TABLE gnt.party_role_del
(
  party_id character varying(20) NOT NULL,
  role_type_id character varying(20) NOT NULL,
  last_updated_stamp timestamp with time zone,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_role_del PRIMARY KEY (party_id, role_type_id)
);
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_model_del PRIMARY KEY (model_code)
);
...
CREATE TABLE gnt.measure_or_activity_list_del
(
  seq_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_measure_or_activity_list_del PRIMARY KEY (activity_id)
);
...
CREATE TABLE gnt.ohe_location_del
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_ohe_location_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.party_contact_mech_del
(
  party_id character varying(20) NOT NULL,
  contact_mech_id character varying(20) NOT NULL,
  from_date timestamp with time zone NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_contact_mech_del PRIMARY KEY (party_id, contact_mech_id, from_date)
);
...
CREATE TABLE gnt.party_contact_mech_purpose_del
(
  party_id character varying(20) NOT NULL,
  contact_mech_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_contact_mech_purpose_del PRIMARY KEY (party_id, contact_mech_id, contact_mech_purpose_type_id, from_date)
);
...
CREATE TABLE gnt.party_group_del
(
  party_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_party_group_del PRIMARY KEY (party_id)
);
...
CREATE TABLE gnt.party_supplemental_data_del
(
  party_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_party_supplemental_data_del PRIMARY KEY (party_id)
);
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_line_del PRIMARY KEY (line_id)
);
...
(
  ...
  CONSTRAINT pk_lot_del PRIMARY KEY (lot_id)
);
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_make_del PRIMARY KEY (make_code)
);
...
CREATE TABLE gnt.inspection_type_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_inspection_type_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.inspection_del
(
  ...
  CONSTRAINT pk_inspection_del PRIMARY KEY (inspection_seq_id)
);
...
CREATE TABLE gnt.good_identification_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_good_identification_type_del PRIMARY KEY (good_identification_type_id),
  CONSTRAINT good_id_type_par FOREIGN KEY (parent_type_id)
      REFERENCES gnt.good_identification_type_del (good_identification_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.foot_patrolling_sections_del
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_foot_patrolling_sections_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.departments_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_departments_del PRIMARY KEY (dept_id)
);
...
CREATE TABLE gnt.content_purpose_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_content_purpose_type_del PRIMARY KEY (content_purpose_type_id)
);
...
CREATE TABLE gnt.content_type_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_content_type_del PRIMARY KEY (content_type_id),
  CONSTRAINT cntnt_type_parent FOREIGN KEY (parent_type_id)
      REFERENCES gnt.content_type_del (content_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.country_code_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_country_code_del PRIMARY KEY (country_code)
);
...
CREATE TABLE gnt.country_capital_del
(
  country_code character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_country_capital_del PRIMARY KEY (country_code),
  CONSTRAINT cntry_cap_to_code FOREIGN KEY (country_code)
      REFERENCES gnt.country_code_del (country_code) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.country_tele_code_del
(
  country_code character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_country_tele_code_del PRIMARY KEY (country_code),
...
CREATE TABLE gnt.consignee_del
(
  ...
  unit_code character varying(20),
  unit_type character varying(20),
  CONSTRAINT pk_consignee_del PRIMARY KEY (consignee_code)
) ;
...
CREATE TABLE gnt.tpc_board_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_tx_stamp timestamp with time zone,
  description character varying(255),
  CONSTRAINT pk_tpc_board_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.tpc_board_reporting_facilitys_del
(
  seq_id character varying(20) NOT NULL,
  ...
  unit_id character varying(20),
  description character varying(255),
  CONSTRAINT pk_tpc_board_reporting_facilit_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.tss_feeder_master_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_tss_feeder_master_del PRIMARY KEY (feeder_id)
);
...
CREATE TABLE gnt.user_defualt_fac_cons_ind_etc_del
(
  ...
  CONSTRAINT pk_user_defualt_fac_cons_ind_etc_del PRIMARY KEY (sequence_id),
...
CREATE TABLE gnt.elementary_sections_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_elementary_sections_del PRIMARY KEY (seq_id),
...
CREATE TABLE gnt.elementary_section_lines_del
(
  seq_id character varying(20) NOT NULL,
  elementary_section_code character varying(100),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_elementary_section_lines_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.elementary_section_controls_del
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_elementary_section_controls_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.energy_meter_del
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_energy_meter_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.energy_consumption_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_energy_consumption_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.functional_location_hierarchy_del
(
  ...
  CONSTRAINT pk_functional_location_hierarc_del PRIMARY KEY (party_id)
);
...
CREATE TABLE gnt.gantry_master_data_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_gantry_master_data_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.asset_schedule_assoc_del
(
  ...
  CONSTRAINT pk_asset_schedule_assoc_del PRIMARY KEY (asset_type, schedule_code)
);
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_schedule_del PRIMARY KEY (schedule_code)
);
...
(
  ...
  CONSTRAINT pk_sectors_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.sub_sectors_del
(
  seq_id character varying(20) NOT NULL,
  ...
  line1 character varying(20),
  line2 character varying(20),
  CONSTRAINT pk_sub_sectors_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.stations_sections_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_stations_sections_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.asset_master_data_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_master_data_del PRIMARY KEY (seq_id),
  CONSTRAINT asset_facility FOREIGN KEY (facility_id)
      REFERENCES gnt.facility_del (facility_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT asset_mast_pro FOREIGN KEY (asset_type)
      REFERENCES gnt.product_del (product_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.asset_master_history_del
(
  seq_id character varying(20) NOT NULL,
  asset_type character varying(20),
  section character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_master_history_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.asset_monthly_targets_del
(
  seq_id character varying(20),
  facility_id character varying(20) NOT NULL,
  elementary_section character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_monthly_targets_del PRIMARY KEY (facility_id, schedule_type, asset_type, year)
);
...
CREATE TABLE gnt.asset_schedule_activity_assoc_del
(
  seq_id character varying(20) NOT NULL,
  asa_seq_id character varying(20),
  ...
  CONSTRAINT pk_asset_schedule_activity_ass_del PRIMARY KEY (seq_id),
  CONSTRAINT asset_schedule_act FOREIGN KEY (activity_id)
      REFERENCES gnt.measure_or_activity_list_del (activity_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.asset_schedule_activity_record_del
(
  ...
  device_delated_stamp timestamp with time zone,
  ...
  CONSTRAINT pk_asset_schedule_activity_rec_del PRIMARY KEY (asset_id, schedule_code, schedule_date),
  CONSTRAINT asset_schedule_rec FOREIGN KEY (schedule_code)
      REFERENCES gnt.schedule_del (schedule_code) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.assets_schedule_history_del
(
  seq_id character varying(20) NOT NULL,
  facility_id character varying(20),
  asset_type character varying(20),
  ...
  device_last_updated_stamp timestamp with time zone,
  CONSTRAINT pk_assets_schedule_history_del PRIMARY KEY (seq_id),
...
CREATE TABLE gnt.asset_status_update_del
(
  seq_id character varying(20) NOT NULL,
  created_date timestamp with time zone,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_status_update_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.assets_monthly_targets_history_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_assets_monthly_targets_hist_del PRIMARY KEY (seq_id)
);
...
CREATE TABLE gnt.daily_progress_summery_del
(
  seq_id character varying(20) NOT NULL,
  created_date timestamp with time zone,
  facility_id character varying(20),
  ...
  CONSTRAINT pk_daily_progress_summery_del PRIMARY KEY (seq_id),
...
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_dmtr_del PRIMARY KEY (dmtr_seq_id)
);
...
CREATE TABLE gnt.dmtr_inventoryetc_assoc_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_dmtr_inventoryetc_assoc_del PRIMARY KEY (dmtr_inventoryetc_assoc_seq_id)
);
...
CREATE TABLE gnt.good_identification_del
(
  good_identification_type_id character varying(20) NOT NULL,
  product_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_good_identification_del PRIMARY KEY (good_identification_type_id, product_id),
...
CREATE TABLE gnt.incoming_consignment_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_incoming_consignment_del PRIMARY KEY (incoming_consignment_id)
);
...
CREATE TABLE gnt.incoming_consignment_detail_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_incoming_consignment_detail_del PRIMARY KEY (incoming_consignment_detail_id),
  CONSTRAINT incoming_consignment_id FOREIGN KEY (incoming_consignment_id)
      REFERENCES gnt.incoming_consignment_del (incoming_consignment_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.indent_track_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_indent_track_del PRIMARY KEY (sequence_id)
);
...
CREATE TABLE gnt.inventory_item_del
(
  ...
  CONSTRAINT pk_inventory_item_del PRIMARY KEY (inventory_item_id)
);
...
CREATE TABLE gnt.item_issuance_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_item_issuance_del PRIMARY KEY (item_issuance_id)
);
...
CREATE TABLE gnt.work_effort_del
(
  ...
  created_tx_stamp timestamp with time zone,
  sequence_num numeric(20,0),
  CONSTRAINT pk_work_effort_del PRIMARY KEY (work_effort_id),
  /*
  ...
  */
  ...
  CONSTRAINT wk_effrt_parent FOREIGN KEY (work_effort_parent_id)
      REFERENCES gnt.work_effort_del (work_effort_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
      /*
  ...
  CONSTRAINT wk_effrt_type FOREIGN KEY (work_effort_type_id)
      REFERENCES gnt.work_effort_type_del (work_effort_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.work_effort_status_del
(
  work_effort_id character varying(60) NOT NULL,
  status_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_work_effort_status_del PRIMARY KEY (work_effort_id, status_id, status_datetime),
  CONSTRAINT wkeff_stts_sb_ul FOREIGN KEY (set_by_user_login)
      REFERENCES gnt.user_login_del (user_login_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wkeff_stts_stts FOREIGN KEY (status_id)
      REFERENCES gnt.status_item_del (status_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE gnt.inventory_item_detail_del
(
  inventory_item_id character varying(20) NOT NULL,
  ...
  functional_unit character varying(100),
  issue_purpose character varying(100),
  CONSTRAINT pk_inventory_item_detail_del PRIMARY KEY (inventory_item_id, inventory_item_detail_seq_id),
...
*/
  CONSTRAINT inv_itdtl_invit FOREIGN KEY (inventory_item_id)
      REFERENCES gnt.inventory_item_del (inventory_item_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT inv_itdtl_itmis FOREIGN KEY (item_issuance_id)
      REFERENCES gnt.item_issuance_del (item_issuance_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
/*
...
CREATE TABLE gnt.inventory_item_status_del
(
  inventory_item_id character varying(20) NOT NULL,
  status_id character varying(20) NOT NULL,
  status_datetime timestamp with time zone NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_inventory_item_status_del PRIMARY KEY (inventory_item_id, status_id, status_datetime)
);
...
CREATE TABLE gnt.inventory_transfer_del
(
  ...
  issue_purpose character varying(100),
  CONSTRAINT pk_inventory_transfer_del PRIMARY KEY (inventory_transfer_id)
);
...
CREATE TABLE gnt.pb_switch_control_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_pb_switch_control_del PRIMARY KEY (seq_id)
);
...
(
  ...
  CONSTRAINT pk_person_del PRIMARY KEY (party_id)
);
...
CREATE TABLE gnt.power_blocks_del
(
  ...
  CONSTRAINT pk_power_blocks_del PRIMARY KEY (pb_operation_seq_id)
);
...
CREATE TABLE gnt.power_blocks_amendment_del
(
  pb_operation_seq_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_power_blocks_amendment_del PRIMARY KEY (pb_amendment_seq_id),
  CONSTRAINT pb_adm FOREIGN KEY (pb_operation_seq_id)
      REFERENCES gnt.power_blocks_del (pb_operation_seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.requirement_status_del
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_requirement_status_del PRIMARY KEY (requirement_id, status_id)
);
...
CREATE TABLE gnt.requirement_del
(
  requirement_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_requirement_del PRIMARY KEY (requirement_id),
  /*
  ...
  */
  ...
  CONSTRAINT req_type FOREIGN KEY (requirement_type_id)
      REFERENCES gnt.requirement_type_del (requirement_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE gnt.switch_maintenence_history_del
(
  seq_id character varying(20) NOT NULL,
  pb_operation_seq_id character varying(20),
  ...
  CONSTRAINT pk_switch_maintenence_history_del PRIMARY KEY (seq_id),
...
CREATE TABLE gnt.switch_maintenence_history_amendment_del
(
  seq_id character varying(20),
  ...
  updated_by character varying(255),
  delete character varying(255),
  CONSTRAINT pk_switch_maintenence_history_amendment_del PRIMARY KEY (amendment_seq_id),
  CONSTRAINT sw_pb_adm FOREIGN KEY (seq_id)
      REFERENCES gnt.switch_maintenence_history_del (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
-- Table: gnt.failures_del

-- DROP TABLE gnt.failures_del;

CREATE TABLE gnt.failures_del
(
  ...
  CONSTRAINT pk_failures_del PRIMARY KEY (failure_seq_id)
);




-- Table: gnt.precautionary_measures_master_del

-- DROP TABLE gnt.precautionary_measures_master_del;

CREATE TABLE gnt.precautionary_measures_master_del
(
  from_date_time timestamp with time zone,
  thru_date_time timestamp with time zone,
  location character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_precautionary_measures_mast_del PRIMARY KEY (precautionary_measure)
);




-- Table: gnt.precautionary_measure_del

-- DROP TABLE gnt.precautionary_measure_del;

CREATE TABLE gnt.precautionary_measure_del
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_precautionary_measure_del PRIMARY KEY (seq_id),
  CONSTRAINT precautionarymeasuresmaster_pr FOREIGN KEY (precautionary_measure)
      REFERENCES gnt.precautionary_measures_master_del (precautionary_measure) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
-- Table: gnt.foot_patrolling_inspection_del

-- DROP TABLE gnt.foot_patrolling_inspection_del;

CREATE TABLE gnt.foot_patrolling_inspection_del
(
  seq_id character varying(20) NOT NULL,
  device_id character varying(100),
  ...
  CONSTRAINT pk_foot_patrolling_inspection_del PRIMARY KEY (seq_id)
);



-- Table: gnt.observation_categories_del

-- DROP TABLE gnt.observation_categories_del;

CREATE TABLE gnt.observation_categories_del
(
  seq_id character varying(20) NOT NULL,
  inspection_type character varying(255),
  department character varying(100),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_observation_categories_del PRIMARY KEY (seq_id)
);



-- Table: gnt.observations_check_list_del

-- DROP TABLE gnt.observations_check_list_del;

CREATE TABLE gnt.observations_check_list_del
(
  seq_id character varying(20) NOT NULL,
  inspection_type character varying(255),
  observation_category character varying(255),
  ...
  CONSTRAINT pk_observations_check_list_del PRIMARY KEY (seq_id),
  CONSTRAINT inspectiontype FOREIGN KEY (inspection_type)
      REFERENCES gnt.inspection_type_del (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
-- Table: gnt.observations_del

-- DROP TABLE gnt.observations_del;

CREATE TABLE gnt.observations_del
(
  seq_id character varying(20) NOT NULL,
  device_id character varying(100),
  device_seq_id character varying(100),
  ...
  created_tx_stamp timestamp with time zone,
  location character varying(100),
  CONSTRAINT pk_observations_del PRIMARY KEY (seq_id),
  CONSTRAINT footpatrollinginspection FOREIGN KEY (inspection_seq_id)
      REFERENCES gnt.foot_patrolling_inspection_del (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);



-- Table: gnt.compliances_del

-- DROP TABLE gnt.compliances_del;

CREATE TABLE gnt.compliances_del
(
  seq_id character varying(20) NOT NULL,
  device_id character varying(100),
  device_seq_id character varying(100),
  ...
  action character varying(255),
  CONSTRAINT pk_compliances_del PRIMARY KEY (seq_id),
  CONSTRAINT observations FOREIGN KEY (obeservation_seq_id)
      REFERENCES gnt.observations_del (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
