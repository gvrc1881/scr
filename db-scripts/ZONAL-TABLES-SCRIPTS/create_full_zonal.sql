-- Table: zonal.allocation

-- DROP TABLE zonal.allocation;

CREATE TABLE zonal.allocation
(
  ...
  CONSTRAINT pk_allocation PRIMARY KEY (allocation_code)
);


-- Table: zonal.uom_type

-- DROP TABLE zonal.uom_type;

CREATE TABLE zonal.uom_type
(
...
-- Table: zonal.inventory_item_type

-- DROP TABLE zonal.inventory_item_type;

CREATE TABLE zonal.inventory_item_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_inventory_item_type PRIMARY KEY (inventory_item_type_id)
);


-- Table: zonal.uom

-- DROP TABLE zonal.uom;

CREATE TABLE zonal.uom
(
...
-- Table: zonal.uom_conversion

-- DROP TABLE zonal.uom_conversion;

CREATE TABLE zonal.uom_conversion
(
  uom_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_uom_conversion PRIMARY KEY (uom_id, uom_id_to)
);

-- Table: zonal.facility_type

-- DROP TABLE zonal.facility_type;

CREATE TABLE zonal.facility_type
(
  ...
  CONSTRAINT facility_typepar FOREIGN KEY (parent_type_id)
      REFERENCES zonal.facility_type (facility_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);



-- Table: zonal.facility

-- DROP TABLE zonal.facility;

CREATE TABLE zonal.facility
(
...
--  default_dimension_uom_id character varying(20),
 ...
 -- organized character varying(20),
  ...
  CONSTRAINT fac_def_uom FOREIGN KEY (default_weight_uom_id)
      REFERENCES zonal.uom (uom_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fac_invitm_type FOREIGN KEY (default_inventory_item_type_id)
      REFERENCES zonal.inventory_item_type (inventory_item_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT facility_fctyp FOREIGN KEY (facility_type_id)
      REFERENCES zonal.facility_type (facility_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
 -- CONSTRAINT facility_geopt FOREIGN KEY (geo_point_id)
 --     REFERENCES zonal.geo_point (geo_point_id) MATCH SIMPLE
      --ON UPDATE NO ACTION ON DELETE NO ACTION,
 -- CONSTRAINT facility_owner FOREIGN KEY (owner_party_id)
 --     REFERENCES zonal.party (party_id) MATCH SIMPLE
 --     ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT facility_parent FOREIGN KEY (parent_facility_id)
      REFERENCES zonal.facility (facility_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
--  CONSTRAINT facility_pgrp FOREIGN KEY (primary_facility_group_id)
  --    REFERENCES zonal.facility_group (facility_group_id) MATCH SIMPLE
    --  ON UPDATE NO ACTION ON DELETE NO ACTION,
 -- CONSTRAINT fclt_rordenum FOREIGN KEY (reserve_order_enum_id)
  --    REFERENCES zonal.enumeration (enum_id) MATCH SIMPLE
    --  ON UPDATE NO ACTION ON DELETE NO ACTION
);

--2
-- Table: zonal.app_device

-- DROP TABLE zonal.app_device;

CREATE TABLE zonal.app_device
(
  ...
  CONSTRAINT pk_app_device PRIMARY KEY (seq_id)
);


-- Table: zonal.party

-- DROP TABLE zonal.party;

CREATE TABLE zonal.party
(
...
-- Table: zonal.user_login

-- DROP TABLE zonal.user_login;

CREATE TABLE zonal.user_login
(
...
-- Table: zonal.user_login_history

-- DROP TABLE zonal.user_login_history;

CREATE TABLE zonal.user_login_history
(
  user_login_id character varying(255) NOT NULL,
...
--3
-- Table: zonal.app_device_login

-- DROP TABLE zonal.app_device_login;

CREATE TABLE zonal.app_device_login
(
  seq_id character varying(20) NOT NULL,
  app_name character varying(100),
  device_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_app_device_login PRIMARY KEY (seq_id),
  CONSTRAINT app_device_usrlog FOREIGN KEY (user_login_id)
      REFERENCES zonal.user_login (user_login_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

--4
-- Table: zonal.app_device_unit

-- DROP TABLE zonal.app_device_unit;

CREATE TABLE zonal.app_device_unit
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT app_device_unit_seqid FOREIGN KEY (app_device_seq_id)
      REFERENCES zonal.app_device (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
...
--5
-- Table: zonal.asset_make_model_assoc

-- DROP TABLE zonal.asset_make_model_assoc;

CREATE TABLE zonal.asset_make_model_assoc
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_make_model_assoc PRIMARY KEY (asset_type, make_code)
);

-- Table: zonal.work_effort_type

-- DROP TABLE zonal.work_effort_type;

CREATE TABLE zonal.work_effort_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_work_effort_type PRIMARY KEY (work_effort_type_id)
);


-- Table: zonal.telecom_number

-- DROP TABLE zonal.telecom_number;

CREATE TABLE zonal.telecom_number
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_telecom_number PRIMARY KEY (contact_mech_id)
);

-- Table: zonal.structure_type

-- 

CREATE TABLE zonal.structure_type
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_structure_type PRIMARY KEY (seq_id)
);


-- Table: zonal.status_type

-- DROP TABLE zonal.status_type;

CREATE TABLE zonal.status_type
(
...
-- Table: zonal.status_item

-- DROP TABLE zonal.status_item;

CREATE TABLE zonal.status_item
(
...
-- Table: zonal.status_valid_change

-- DROP TABLE zonal.status_valid_change;

CREATE TABLE zonal.status_valid_change
(
  status_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_status_valid_change PRIMARY KEY (status_id, status_id_to)
);

-- Table: zonal.role_type

-- DROP TABLE zonal.role_type;

CREATE TABLE zonal.role_type
(
...
-- Table: zonal.requirement_type

-- DROP TABLE zonal.requirement_type;

CREATE TABLE zonal.requirement_type
(
...
-- Table: zonal.psi_report_registry

-- DROP TABLE zonal.psi_report_registry;

CREATE TABLE zonal.psi_report_registry
(
  ...
  CONSTRAINT pk_psi_report_registry PRIMARY KEY (report_id)
);

-- Table: zonal.report_group

-- DROP TABLE zonal.report_group;

CREATE TABLE zonal.report_group
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_report_group PRIMARY KEY (report_group_id)
);

-- Table: zonal.report_registry

-- DROP TABLE zonal.report_registry;

CREATE TABLE zonal.report_registry
(
  report_id character varying(20) NOT NULL,
  ...
  report_header text,
  report_code character varying(100),
  CONSTRAINT pk_report_registry PRIMARY KEY (report_id)
);

-- Table: zonal.report_group_member

-- DROP TABLE zonal.report_group_member;

CREATE TABLE zonal.report_group_member
(
  report_group_id character varying(20) NOT NULL,
  report_id character varying(20) NOT NULL,
  sequence_num numeric(20,0),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_report_group_member PRIMARY KEY (report_group_id, report_id)
);



-- Table: zonal.product_type

-- DROP TABLE zonal.product_type;

CREATE TABLE zonal.product_type
(
...
-- DROP TABLE zonal.product;

CREATE TABLE zonal.product
(
...
-- Table: zonal.product_category_type

-- DROP TABLE zonal.product_category_type;

CREATE TABLE zonal.product_category_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_product_category_type PRIMARY KEY (product_category_type_id)
);


-- Table: zonal.product_category

-- DROP TABLE zonal.product_category;

CREATE TABLE zonal.product_category
(
...
-- Table: zonal.product_category_member

-- DROP TABLE zonal.product_category_member;

CREATE TABLE zonal.product_category_member
(
  product_category_id character varying(20) NOT NULL,
  product_id character varying(20) NOT NULL,
  from_date timestamp with time zone NOT NULL,
...
-- Table: zonal.priority_type

-- DROP TABLE zonal.priority_type;

CREATE TABLE zonal.priority_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_priority_type PRIMARY KEY (priority_type_id)
);


-- Table: zonal.period_type

-- DROP TABLE zonal.period_type;

CREATE TABLE zonal.period_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_period_type PRIMARY KEY (period_type_id)
);

-- Table: zonal.party_status

-- DROP TABLE zonal.party_status;

CREATE TABLE zonal.party_status
(
  status_id character varying(20) NOT NULL,
  party_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_status PRIMARY KEY (status_id, party_id, status_date)
);


-- Table: zonal.party_role

-- DROP TABLE zonal.party_role;

CREATE TABLE zonal.party_role
(
  party_id character varying(20) NOT NULL,
  role_type_id character varying(20) NOT NULL,
  last_updated_stamp timestamp with time zone,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_role PRIMARY KEY (party_id, role_type_id)
);


-- Table: zonal.model

-- DROP TABLE zonal.model;

CREATE TABLE zonal.model
(
  seq_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_model PRIMARY KEY (model_code)
);

-- Table: zonal.measure_or_activity_list

-- DROP TABLE zonal.measure_or_activity_list;

CREATE TABLE zonal.measure_or_activity_list
(
  seq_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_measure_or_activity_list PRIMARY KEY (activity_id)
);


-- Table: zonal.ohe_location

-- DROP TABLE zonal.ohe_location;

CREATE TABLE zonal.ohe_location
(
  seq_id character varying(20) NOT NULL,
...
-- Table: zonal.party_contact_mech

-- DROP TABLE zonal.party_contact_mech;

CREATE TABLE zonal.party_contact_mech
(
  party_id character varying(20) NOT NULL,
  contact_mech_id character varying(20) NOT NULL,
  from_date timestamp with time zone NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_party_contact_mech PRIMARY KEY (party_id, contact_mech_id, from_date)
);


-- Table: zonal.party_contact_mech_purpose

-- DROP TABLE zonal.party_contact_mech_purpose;

CREATE TABLE zonal.party_contact_mech_purpose
(
  party_id character varying(20) NOT NULL,
  contact_mech_id character varying(20) NOT NULL,
...
-- Table: zonal.party_group

-- DROP TABLE zonal.party_group;

CREATE TABLE zonal.party_group
(
  party_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_party_group PRIMARY KEY (party_id)
);
...
-- Table: zonal.party_supplemental_data

-- DROP TABLE zonal.party_supplemental_data;

CREATE TABLE zonal.party_supplemental_data
(
  party_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_party_supplemental_data PRIMARY KEY (party_id)
);
...
-- DROP TABLE zonal.line;

CREATE TABLE zonal.line
(
...
-- DROP TABLE zonal.lot;

CREATE TABLE zonal.lot
(
...
-- DROP TABLE zonal.make;

CREATE TABLE zonal.make
(
  seq_id character varying(20),
  make_code character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_make PRIMARY KEY (make_code)
);



-- Table: zonal.inspection_type

-- DROP TABLE zonal.inspection_type;

CREATE TABLE zonal.inspection_type
(
  seq_id character varying(20) NOT NULL,
...
-- Table: zonal.inspection

-- DROP TABLE zonal.inspection;

CREATE TABLE zonal.inspection
(
  ...
  CONSTRAINT pk_inspection PRIMARY KEY (inspection_seq_id)
);

-- Table: zonal.good_identification_type

-- DROP TABLE zonal.good_identification_type;

CREATE TABLE zonal.good_identification_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_good_identification_type PRIMARY KEY (good_identification_type_id),
  CONSTRAINT good_id_type_par FOREIGN KEY (parent_type_id)
      REFERENCES zonal.good_identification_type (good_identification_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);


-- Table: zonal.foot_patrolling_sections

-- DROP TABLE zonal.foot_patrolling_sections;

CREATE TABLE zonal.foot_patrolling_sections
(
  seq_id character varying(20) NOT NULL,
...
-- Table: zonal.departments

-- DROP TABLE zonal.departments;

CREATE TABLE zonal.departments
(
...
-- Table: zonal.content_purpose_type

-- DROP TABLE zonal.content_purpose_type;

CREATE TABLE zonal.content_purpose_type
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_content_purpose_type PRIMARY KEY (content_purpose_type_id)
);

-- Table: zonal.content_type

-- DROP TABLE zonal.content_type;

CREATE TABLE zonal.content_type
(
  ...
  CONSTRAINT cntnt_type_parent FOREIGN KEY (parent_type_id)
      REFERENCES zonal.content_type (content_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Table: zonal.country_code

-- DROP TABLE zonal.country_code;

CREATE TABLE zonal.country_code
(
...
-- Table: zonal.country_capital

-- DROP TABLE zonal.country_capital;

CREATE TABLE zonal.country_capital
(
  country_code character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_country_capital PRIMARY KEY (country_code),
  CONSTRAINT cntry_cap_to_code FOREIGN KEY (country_code)
      REFERENCES zonal.country_code (country_code) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);


-- Table: zonal.country_tele_code

-- DROP TABLE zonal.country_tele_code;

CREATE TABLE zonal.country_tele_code
(
  country_code character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_country_tele_code PRIMARY KEY (country_code),
...
-- Table: zonal.consignee

-- DROP TABLE zonal.consignee;

CREATE TABLE zonal.consignee
(
  ...
  unit_code character varying(20),
  unit_type character varying(20),
  CONSTRAINT pk_consignee PRIMARY KEY (consignee_code)
) ;



-- Table: zonal.tpc_board

-- DROP TABLE zonal.tpc_board;

CREATE TABLE zonal.tpc_board
(
  seq_id character varying(20) NOT NULL,
  ...
  created_tx_stamp timestamp with time zone,
  description character varying(255),
  CONSTRAINT pk_tpc_board PRIMARY KEY (seq_id)
);

-- Table: zonal.tpc_board_reporting_facilitys

-- DROP TABLE zonal.tpc_board_reporting_facilitys;

CREATE TABLE zonal.tpc_board_reporting_facilitys
(
  seq_id character varying(20) NOT NULL,
  ...
  unit_id character varying(20),
  description character varying(255),
  CONSTRAINT pk_tpc_board_reporting_facilit PRIMARY KEY (seq_id)
);

-- Table: zonal.tss_feeder_master

-- DROP TABLE zonal.tss_feeder_master;

CREATE TABLE zonal.tss_feeder_master
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_tss_feeder_master PRIMARY KEY (feeder_id)
);


-- Table: zonal.user_defualt_fac_cons_ind_etc

-- DROP TABLE zonal.user_defualt_fac_cons_ind_etc;

CREATE TABLE zonal.user_defualt_fac_cons_ind_etc
(
  ...
  CONSTRAINT pk_user_defualt_fac_cons_ind_e PRIMARY KEY (sequence_id),
...
-- Table: zonal.elementary_sections

-- DROP TABLE zonal.elementary_sections;

CREATE TABLE zonal.elementary_sections
(
  seq_id character varying(20) NOT NULL,
...
-- Table: zonal.elementary_section_lines

-- DROP TABLE zonal.elementary_section_lines;

CREATE TABLE zonal.elementary_section_lines
(
  seq_id character varying(20) NOT NULL,
  elementary_section_code character varying(100),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_elementary_section_lines PRIMARY KEY (seq_id)
);


-- Table: zonal.elementary_section_controls

-- DROP TABLE zonal.elementary_section_controls;

CREATE TABLE zonal.elementary_section_controls
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_elementary_section_controls PRIMARY KEY (seq_id)
);

-- Table: zonal.energy_meter

-- DROP TABLE zonal.energy_meter;

CREATE TABLE zonal.energy_meter
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_energy_meter PRIMARY KEY (seq_id)
);

-- Table: zonal.energy_consumption

-- DROP TABLE zonal.energy_consumption;

CREATE TABLE zonal.energy_consumption
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_energy_consumption PRIMARY KEY (seq_id)
);




-- Table: zonal.functional_location_hierarchy

-- DROP TABLE zonal.functional_location_hierarchy;

CREATE TABLE zonal.functional_location_hierarchy
(
...
-- Table: zonal.gantry_master_data

-- DROP TABLE zonal.gantry_master_data;

CREATE TABLE zonal.gantry_master_data
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_gantry_master_data PRIMARY KEY (seq_id)
);

-- Table: zonal.asset_schedule_assoc

-- DROP TABLE zonal.asset_schedule_assoc;

CREATE TABLE zonal.asset_schedule_assoc
(
  ...
  CONSTRAINT pk_asset_schedule_assoc PRIMARY KEY (asset_type, schedule_code)
);




-- Table: zonal.schedule

-- DROP TABLE zonal.schedule;

CREATE TABLE zonal.schedule
(
  seq_id character varying(20),
  schedule_code character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_schedule PRIMARY KEY (schedule_code)
);

-- Table: zonal.sectors

-- DROP TABLE zonal.sectors;

CREATE TABLE zonal.sectors
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT pk_sectors PRIMARY KEY (seq_id)
);


-- Table: zonal.sub_sectors

-- DROP TABLE zonal.sub_sectors;

CREATE TABLE zonal.sub_sectors
(
  seq_id character varying(20) NOT NULL,
  ...
  line1 character varying(20),
  line2 character varying(20),
  CONSTRAINT pk_sub_sectors PRIMARY KEY (seq_id)
);

-- Table: zonal.stations_sections

-- DROP TABLE zonal.stations_sections;

CREATE TABLE zonal.stations_sections
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_stations_sections PRIMARY KEY (seq_id)
);



-- Table: zonal.asset_master_data

-- DROP TABLE zonal.asset_master_data;

CREATE TABLE zonal.asset_master_data
(
  seq_id character varying(20) NOT NULL,
  ...
  CONSTRAINT asset_mast_pro FOREIGN KEY (asset_type)
      REFERENCES zonal.product (product_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Table: zonal.asset_master_history

-- DROP TABLE zonal.asset_master_history;

CREATE TABLE zonal.asset_master_history
(
  seq_id character varying(20) NOT NULL,
  asset_type character varying(20),
  section character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_master_history PRIMARY KEY (seq_id)
);

-- Table: zonal.asset_monthly_targets

-- DROP TABLE zonal.asset_monthly_targets;

CREATE TABLE zonal.asset_monthly_targets
(
  seq_id character varying(20),
  facility_id character varying(20) NOT NULL,
  elementary_section character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_monthly_targets PRIMARY KEY (facility_id, schedule_type, asset_type, year)
);

-- Table: zonal.asset_schedule_activity_assoc

-- DROP TABLE zonal.asset_schedule_activity_assoc;

CREATE TABLE zonal.asset_schedule_activity_assoc
(
  seq_id character varying(20) NOT NULL,
  asa_seq_id character varying(20),
  ...
  CONSTRAINT asset_schedule_act FOREIGN KEY (activity_id)
      REFERENCES zonal.measure_or_activity_list (activity_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Table: zonal.asset_schedule_activity_record

-- DROP TABLE zonal.asset_schedule_activity_record;

CREATE TABLE zonal.asset_schedule_activity_record
(
  ...
  CONSTRAINT pk_asset_schedule_activity_rec PRIMARY KEY (asset_id, schedule_code, schedule_date),
  CONSTRAINT asset_schedule_rec FOREIGN KEY (schedule_code)
      REFERENCES zonal.schedule (schedule_code) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);


-- Table: zonal.assets_schedule_history

-- DROP TABLE zonal.assets_schedule_history;

CREATE TABLE zonal.assets_schedule_history
(
  seq_id character varying(20) NOT NULL,
  facility_id character varying(20),
  asset_type character varying(20),
  ...
  device_created_stamp timestamp with time zone,
  device_last_updated_stamp timestamp with time zone,
  CONSTRAINT pk_assets_schedule_history PRIMARY KEY (seq_id),
  CONSTRAINT asset_schedule_hist FOREIGN KEY (schedule_code)
      REFERENCES zonal.schedule (schedule_code) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Table: zonal.asset_status_update

-- DROP TABLE zonal.asset_status_update;

CREATE TABLE zonal.asset_status_update
(
  seq_id character varying(20) NOT NULL,
  created_date timestamp with time zone,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_asset_status_update PRIMARY KEY (seq_id)
);

-- Table: zonal.assets_monthly_targets_history

-- DROP TABLE zonal.assets_monthly_targets_history;

CREATE TABLE zonal.assets_monthly_targets_history
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_assets_monthly_targets_hist PRIMARY KEY (seq_id)
);



-- Table: zonal.daily_progress_summery

-- DROP TABLE zonal.daily_progress_summery;

CREATE TABLE zonal.daily_progress_summery
(
  seq_id character varying(20) NOT NULL,
  created_date timestamp with time zone,
  facility_id character varying(20),
  ...
  CONSTRAINT pk_daily_progress_summery PRIMARY KEY (seq_id),
...
-- DROP TABLE zonal.dmtr;

CREATE TABLE zonal.dmtr
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_dmtr PRIMARY KEY (dmtr_seq_id)
);

-- Table: zonal.dmtr_inventoryetc_assoc

-- DROP TABLE zonal.dmtr_inventoryetc_assoc;

CREATE TABLE zonal.dmtr_inventoryetc_assoc
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_dmtr_inventoryetc_assoc PRIMARY KEY (dmtr_inventoryetc_assoc_seq_id)
);




-- Table: zonal.good_identification

-- DROP TABLE zonal.good_identification;

CREATE TABLE zonal.good_identification
(
  good_identification_type_id character varying(20) NOT NULL,
  product_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_good_identification PRIMARY KEY (good_identification_type_id, product_id),
...
-- Table: zonal.incoming_consignment

-- DROP TABLE zonal.incoming_consignment;

CREATE TABLE zonal.incoming_consignment
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_incoming_consignment PRIMARY KEY (incoming_consignment_id)
);


-- Table: zonal.incoming_consignment_detail

-- DROP TABLE zonal.incoming_consignment_detail;

CREATE TABLE zonal.incoming_consignment_detail
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_incoming_consignment_detail PRIMARY KEY (incoming_consignment_detail_id),
  CONSTRAINT incoming_consignment_id FOREIGN KEY (incoming_consignment_id)
      REFERENCES zonal.incoming_consignment (incoming_consignment_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);


-- Table: zonal.indent_track

-- DROP TABLE zonal.indent_track;

CREATE TABLE zonal.indent_track
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_indent_track PRIMARY KEY (sequence_id)
);


-- Table: zonal.inventory_item

-- DROP TABLE zonal.inventory_item;

CREATE TABLE zonal.inventory_item
(
...
-- Table: zonal.item_issuance

-- DROP TABLE zonal.item_issuance;

CREATE TABLE zonal.item_issuance
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_item_issuance PRIMARY KEY (item_issuance_id)
);


-- Table: zonal.work_effort

-- DROP TABLE zonal.work_effort;

CREATE TABLE zonal.work_effort
(
  ...
  created_tx_stamp timestamp with time zone,
  sequence_num numeric(20,0),
  CONSTRAINT pk_work_effort PRIMARY KEY (work_effort_id),
  /*
  CONSTRAINT wk_effrt_acc_map FOREIGN KEY (accommodation_map_id)
      REFERENCES zonal.accommodation_map (accommodation_map_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wk_effrt_acc_spot FOREIGN KEY (accommodation_spot_id)
      REFERENCES zonal.accommodation_spot (accommodation_spot_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wk_effrt_curstts FOREIGN KEY (current_status_id)
      REFERENCES zonal.status_item (status_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wk_effrt_cus_met FOREIGN KEY (estimate_calc_method)
      REFERENCES zonal.custom_method (custom_method_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  */
  ...
  CONSTRAINT wk_effrt_fxdasst FOREIGN KEY (fixed_asset_id)
      REFERENCES zonal.fixed_asset (fixed_asset_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
      */
  ...
  /*CONSTRAINT wk_effrt_note FOREIGN KEY (note_id)
      REFERENCES zonal.note_data (note_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
      */
  CONSTRAINT wk_effrt_parent FOREIGN KEY (work_effort_parent_id)
      REFERENCES zonal.work_effort (work_effort_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
      /*
  CONSTRAINT wk_effrt_prptyp FOREIGN KEY (work_effort_purpose_type_id)
      REFERENCES zonal.work_effort_purpose_type (work_effort_purpose_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
   
  CONSTRAINT wk_effrt_recinfo FOREIGN KEY (recurrence_info_id)
      REFERENCES zonal.recurrence_info (recurrence_info_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wk_effrt_rntmdta FOREIGN KEY (runtime_data_id)
      REFERENCES zonal.runtime_data (runtime_data_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wk_effrt_sc_enum FOREIGN KEY (scope_enum_id)
      REFERENCES zonal.enumeration (enum_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT wk_effrt_tempexpr FOREIGN KEY (temp_expr_id)
      REFERENCES zonal.temporal_expression (temp_expr_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
         */
  CONSTRAINT wk_effrt_type FOREIGN KEY (work_effort_type_id)
      REFERENCES zonal.work_effort_type (work_effort_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Table: zonal.work_effort_status

-- DROP TABLE zonal.work_effort_status;

CREATE TABLE zonal.work_effort_status
(
  work_effort_id character varying(60) NOT NULL,
  status_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_work_effort_status PRIMARY KEY (work_effort_id, status_id, status_datetime),
...
-- Table: zonal.inventory_item_detail

-- DROP TABLE zonal.inventory_item_detail;

CREATE TABLE zonal.inventory_item_detail
(
  inventory_item_id character varying(20) NOT NULL,
  ...
  CONSTRAINT inv_itdtl_famnt FOREIGN KEY (fixed_asset_id, maint_hist_seq_id)
      REFERENCES zonal.fixed_asset_maint (fixed_asset_id, maint_hist_seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
*/
  CONSTRAINT inv_itdtl_invit FOREIGN KEY (inventory_item_id)
      REFERENCES zonal.inventory_item (inventory_item_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT inv_itdtl_itmis FOREIGN KEY (item_issuance_id)
      REFERENCES zonal.item_issuance (item_issuance_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
/*
  CONSTRAINT inv_itdtl_phinv FOREIGN KEY (physical_inventory_id)
      REFERENCES zonal.physical_inventory (physical_inventory_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  ...
  CONSTRAINT inv_itdtl_shrct FOREIGN KEY (receipt_id)
      REFERENCES zonal.shipment_receipt (receipt_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
      */
...
-- Table: zonal.inventory_item_status

-- DROP TABLE zonal.inventory_item_status;

CREATE TABLE zonal.inventory_item_status
(
  inventory_item_id character varying(20) NOT NULL,
  status_id character varying(20) NOT NULL,
  status_datetime timestamp with time zone NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_inventory_item_status PRIMARY KEY (inventory_item_id, status_id, status_datetime)
);

-- Table: zonal.inventory_transfer

-- DROP TABLE zonal.inventory_transfer;

CREATE TABLE zonal.inventory_transfer
(
...
-- DROP TABLE zonal.mir;

CREATE TABLE zonal.mir
(
...
*/
-- Table: zonal.pb_switch_control

-- DROP TABLE zonal.pb_switch_control;

CREATE TABLE zonal.pb_switch_control
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_pb_switch_control PRIMARY KEY (seq_id)
);


-- Table: zonal.person

-- DROP TABLE zonal.person;

CREATE TABLE zonal.person
(
  party_id character varying(20) NOT NULL,
...
-- Table: zonal.power_blocks

-- DROP TABLE zonal.power_blocks;

CREATE TABLE zonal.power_blocks
(
...
-- Table: zonal.power_blocks_amendment

-- DROP TABLE zonal.power_blocks_amendment;

CREATE TABLE zonal.power_blocks_amendment
(
  pb_operation_seq_id character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_power_blocks_amendment PRIMARY KEY (pb_amendment_seq_id),
  CONSTRAINT pb_adm FOREIGN KEY (pb_operation_seq_id)
      REFERENCES zonal.power_blocks (pb_operation_seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);



-- Table: zonal.requirement_status

-- DROP TABLE zonal.requirement_status;

CREATE TABLE zonal.requirement_status
(
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_requirement_status PRIMARY KEY (requirement_id, status_id)
);
...
-- Table: zonal.requirement

-- DROP TABLE zonal.requirement;

CREATE TABLE zonal.requirement
(
  requirement_id character varying(20) NOT NULL,
  ...
  CONSTRAINT req_deliverable FOREIGN KEY (deliverable_id)
      REFERENCES zonal.deliverable (deliverable_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
      */
  ...
  CONSTRAINT req_orditm_ty FOREIGN KEY (order_item_type_id)
      REFERENCES zonal.order_item_type (order_item_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  */
  ...
  CONSTRAINT req_type FOREIGN KEY (requirement_type_id)
      REFERENCES zonal.requirement_type (requirement_type_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);


-- Table: zonal.switch_maintenence_history

-- DROP TABLE zonal.switch_maintenence_history;

CREATE TABLE zonal.switch_maintenence_history
(
  seq_id character varying(20) NOT NULL,
  pb_operation_seq_id character varying(20),
  ...
  CONSTRAINT pk_switch_maintenence_history PRIMARY KEY (seq_id),
  CONSTRAINT sw_pb FOREIGN KEY (pb_operation_seq_id)
      REFERENCES zonal.power_blocks (pb_operation_seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

-- Table: zonal.switch_maintenence_history_amendment

-- DROP TABLE zonal.switch_maintenence_history_amendment;

CREATE TABLE zonal.switch_maintenence_history_amendment
(
  seq_id character varying(20),
  ...
  updated_by character varying(255),
  delete character varying(255),
  CONSTRAINT pk_switch_maintenence_history_ PRIMARY KEY (amendment_seq_id),
  CONSTRAINT sw_pb_adm FOREIGN KEY (seq_id)
      REFERENCES zonal.switch_maintenence_history (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);



-- Table: zonal.failures

-- DROP TABLE zonal.failures;

CREATE TABLE zonal.failures
(
  ...
  CONSTRAINT pk_failures PRIMARY KEY (failure_seq_id)
);




-- Table: zonal.precautionary_measures_master

-- DROP TABLE zonal.precautionary_measures_master;

CREATE TABLE zonal.precautionary_measures_master
(
  from_date_time timestamp with time zone,
  thru_date_time timestamp with time zone,
  location character varying(20),
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_precautionary_measures_mast PRIMARY KEY (precautionary_measure)
);




-- Table: zonal.precautionary_measure

-- DROP TABLE zonal.precautionary_measure;

CREATE TABLE zonal.precautionary_measure
(
  seq_id character varying(20) NOT NULL,
  ...
  created_stamp timestamp with time zone,
  created_tx_stamp timestamp with time zone,
  CONSTRAINT pk_precautionary_measure PRIMARY KEY (seq_id),
  CONSTRAINT precautionarymeasuresmaster_pr FOREIGN KEY (precautionary_measure)
      REFERENCES zonal.precautionary_measures_master (precautionary_measure) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
-- Table: zonal.foot_patrolling_inspection

-- DROP TABLE zonal.foot_patrolling_inspection;

CREATE TABLE zonal.foot_patrolling_inspection
(
  seq_id character varying(20) NOT NULL,
  device_id character varying(100),
...
-- Table: zonal.observation_categories

-- DROP TABLE zonal.observation_categories;

CREATE TABLE zonal.observation_categories
(
  seq_id character varying(20) NOT NULL,
  inspection_type character varying(255),
  department character varying(100),
...
-- Table: zonal.observations_check_list

-- DROP TABLE zonal.observations_check_list;

CREATE TABLE zonal.observations_check_list
(
  seq_id character varying(20) NOT NULL,
  inspection_type character varying(255),
  observation_category character varying(255),
  ...
  CONSTRAINT inspectiontype FOREIGN KEY (inspection_type)
      REFERENCES zonal.inspection_type (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
-- Table: zonal.observations

-- DROP TABLE zonal.observations;

CREATE TABLE zonal.observations
(
  seq_id character varying(20) NOT NULL,
  device_id character varying(100),
  device_seq_id character varying(100),
  ...
  CONSTRAINT footpatrollinginspection FOREIGN KEY (inspection_seq_id)
      REFERENCES zonal.foot_patrolling_inspection (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);



-- Table: zonal.compliances

-- DROP TABLE zonal.compliances;

CREATE TABLE zonal.compliances
(
  seq_id character varying(20) NOT NULL,
  device_id character varying(100),
  device_seq_id character varying(100),
  ...
  CONSTRAINT observations FOREIGN KEY (obeservation_seq_id)
      REFERENCES zonal.observations (seq_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);
