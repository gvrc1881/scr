 ...
 */
@Entity
@Table(name="zonals_history")
@NamedQuery(name="ZonalHistory.findAll", query="SELECT d FROM ZonalHistory d")
public class ZonalHistory implements Serializable {
	...
	public ZonalHistory(Integer id, Integer jobsHistoryId, String divisionId, String tableName,
			Timestamp updatedDate, Integer updatedRecords, Integer validateMatch, String status) {
		super();
		Id = id;
