...
var JobTypeComponent = /** @class */ (function () {
    function JobTypeComponent(formBuilder, jobTypeService, dialog, spinnerService, commonService) {
    ...
    JobTypeComponent.prototype.ngOnInit = function () {
        ...
        this.jobTypeFormGroup.valueChanges.subscribe(function () {
            _this.onFormValuesChanged();
        });
    };
    JobTypeComponent.prototype.onFormValuesChanged = function () {
        for (var field in this.jobTypeErrors) {
            if (!this.jobTypeErrors.hasOwnProperty(field)) {
                continue;
            }
            this.jobTypeErrors[field] = {};
            var control = this.jobTypeFormGroup.get(field);
            if (control && control.dirty && !control.valid) {
                this.jobTypeErrors[field] = control.errors;
            }
        }
    };
    JobTypeComponent.prototype.duplicateJobTypeName = function () {
        var _this = this;
        var q = new Promise(function (resolve, reject) {
            var jobTypeName = _this.jobTypeFormGroup.controls['jobTypeName'].value;
            //this.jobTypeService.existsJobTypeName(this.jobTypeFormGroup.controls['jobTypeName'].value).subscribe((duplicate) => {
            var filteredArray = !!_this.jobTypeData && _this.jobTypeData.filter(function (jobType) {
    ...
    JobTypeComponent.prototype.onAddJobTypeFormSubmit = function () {
        var _this = this;
        var jobTypeName = this.jobTypeFormGroup.value.jobTypeName;
        ...
        if (this.title == src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].EVENTS.ADD || this.title == src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].EVENTS.SAVE) {
            ...
            this.spinnerService.show();
            this.addJobType = false;
            this.jobTypeService.addJobType(src_app_payloads_job_type_payload__WEBPACK_IMPORTED_MODULE_5__["JobTypePayload"].ADD_PAYLOAD).subscribe(function (response) {
                // console.log('Response: ' + JSON.stringify(response));
                _this.spinnerService.hide();
                _this.jobTypeResponse = response;
                if (!!_this.jobTypeResponse && _this.jobTypeResponse.code == 200) {
                    _this.commonService.showAlertMessage(_this.jobTypeResponse.message);
                    _this.saveJobType = false;
                    _this.findAllJobTypeData();
                    _this.jobTypeFormGroup.reset();
                    _this.addJobType = false;
                }
                else {
                    _this.commonService.showAlertMessage("JobType Addition Failed");
                }
            }, function (error) { return function (error) {
                _this.jobTypeErrors = error;
                console.log(' >>> ERROR ' + error);
                _this.commonService.showAlertMessage(_this.jobTypeErrors);
                _this.spinnerService.hide();
            }; });
        }
            ...
            var jobTypeId = this.jobTypeResponse.jobTypeId;
            ...
            this.jobTypeService.updateJobType(src_app_payloads_job_type_payload__WEBPACK_IMPORTED_MODULE_5__["JobTypePayload"].UPDATE_PAYLOAD).subscribe(function (response) {
                ...
                if (!!_this.jobTypeResponse && _this.jobTypeResponse.code == 200) {
                    ...
                    _this.commonService.showAlertMessage("JobType Updating Failed");
                }
            }, function (error) { return function (error) {
                _this.jobTypeErrors = error;
                // console.log(' >>> ERROR ' + error);
    ...
    JobTypeComponent.prototype.deleteJobType = function (id) {
        var _this = this;
        ...
        this.confirmDialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                ...
                _this.jobTypeService.deleteJobType(id)
                    ...
                    if (!!_this.jobTypeResponse && _this.jobTypeResponse.code == 200) {
                        ...
                        _this.commonService.showAlertMessage("JobType Name Deletion Failed");
                    }
                }, function (error) {
                    _this.jobTypeErrors = error;
                    console.log(' >>> ERROR ' + error);
    ...
    JobTypeComponent.prototype.findAllJobTypeData = function () {
        var _this = this;
        var jobTypeData = [];
        this.jobTypeService.getAllJobTypes().subscribe(function (data) {
            _this.jobTypeData = data;
            for (var i = 0; i < _this.jobTypeData.length; i++) {
                _this.jobTypeData[i].sno = i + 1;
                jobTypeData.push(_this.jobTypeData[i]);
            }
            _this.jobTypeDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](jobTypeData);
            _this.jobTypeDataSource.paginator = _this.jobTypePaginator;
            _this.jobTypeDataSource.sort = _this.sort;
            _this.spinnerService.hide();
        });
    };
    JobTypeComponent.prototype.applyFilter = function (filterValue) {
        filterValue = filterValue.trim(); // Remove whitespace
        filterValue = filterValue.toLowerCase(); // Datasource defaults to lowercase matches
        this.jobTypeDataSource.filter = filterValue;
    };
    JobTypeComponent.prototype.jobTypeEditAction = function (id) {
        var _this = this;
        this.addJobType = true;
        this.jobTypeService.getJobTypeById(id).subscribe(function (response) {
            _this.cloneUpdateJobType = false;
            _this.saveJobType = false;
            _this.jobTypeResponse = response;
            //console.log("resp: " + JSON.stringify(response));
            _this.jobTypeFormGroup.patchValue({
                jobTypeName: _this.jobTypeResponse.jobTypeName
            });
        }, function (error) { return _this.jobTypeErrors = error; });
        this.commonService.scrollTop("forms");
    };
    JobTypeComponent.prototype.editJobTypeById = function (id) {
        this.spinnerService.show();
        this.addJobType = true;
    ...
    JobTypeComponent.prototype.addJobTypeName = function () {
        this.addJobType = true;
        this.title = 'Add';
    };
    JobTypeComponent.prototype.onGoBack = function () {
...
var JobTypeModule = /** @class */ (function () {
    function JobTypeModule() {
    }
    return JobTypeModule;
}());
...
var JobTypeService = /** @class */ (function () {
    ...
    JobTypeService.prototype.getAllJobTypes = function () {
    ...
    JobTypeService.prototype.getJobTypeById = function (id) {
    ...
    JobTypeService.prototype.existsJobTypeName = function (jobTypeName) {
    ...
    JobTypeService.prototype.addJobType = function (jobType) {
    ...
    JobTypeService.prototype.updateJobType = function (jobType) {
    ...
    JobTypeService.prototype.deleteJobType = function (id) {
...
//# sourceMappingURL=components-scheduler-settings-job-type-job-type-module-ngfactory-es5.js.map