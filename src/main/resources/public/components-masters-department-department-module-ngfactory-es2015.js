...
class DepartmentComponent {
    constructor(formBuilder, dialog, spinnerService, commonService, departmentService) {
    ...
    getDepartmentdata() {
        ...
        this.departmentService.findAllDepartments().subscribe((data) => {
            ...
            this.departmentDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](department);
    ...
    onDepartmentSubmit() {
        let departmentName = this.departmentFormGroup.value.departmentName;
        ...
        if (this.title == src_app_common_constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].EVENTS.SAVE) {
            ...
            this.departmentService.addDepartment(src_app_payloads_department_payload__WEBPACK_IMPORTED_MODULE_5__["DepartmentPayload"].ADD_PAYLOAD).subscribe((data) => {
                this.data = data;
            ...
            this.spinnerService.show();
            this.saveDepartment = false;
            let departmentId = this.editDepartResponse.departmentId;
    ...
    duplicateDepartment() {
        const q = new Promise((resolve, reject) => {
            let repartment = this.departmentFormGroup.controls['departmentName'].value;
            ...
            this.departmentService.existsDepartmentName(this.departmentFormGroup.controls['departmentName'].value).subscribe((duplicate) => {
                if (duplicate) {
                    resolve({ 'duplicateDepartment': true });
                }
                else {
...
class DepartmentService {
    ...
    findRepartmentById(departmentId) {
    ...
    existsDepartmentName(departmentName) {
...
//# sourceMappingURL=components-masters-department-department-module-ngfactory-es2015.js.map