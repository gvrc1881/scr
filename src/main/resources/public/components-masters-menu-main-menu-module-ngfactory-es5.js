 ...
 * tslint:disable
 */ 
var styles = ["table[_ngcontent-%COMP%] {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
...
var MainMenuComponent = /** @class */ (function () {
    function MainMenuComponent(formBuilder, _meinMenuService, dialog, spinnerService, commonService) {
    ...
    MainMenuComponent.prototype.ngOnInit = function () {
        ...
        this.MenusList.sort(function (a, b) { return a.MenuName.localeCompare(b.MenuName); });
        this.menuForm = false;
        ...
        this.mainMenuForm.valueChanges.subscribe(function () {
    ...
    MainMenuComponent.prototype.processEditAction = function (id) {
        var _this = this;
        this._meinMenuService.getMainMenuById(id)
            .subscribe(function (resp) {
            _this.response = resp;
            _this.mainMenuForm.patchValue({
                id: _this.response.id,
                menu: _this.response.menu,
                menu_url: _this.response.menuURL
            });
        }, function (error) { return _this.formErrors = error; });
        this.commonService.scrollTop("forms");
    };
    MainMenuComponent.prototype.duplicateMenuName = function () {
        var _this = this;
        var q = new Promise(function (resolve, reject) {
            _this._meinMenuService.duplicateMenuName({
                'menu': _this.commonService.removeSpaceMaoreThanOne(_this.mainMenuForm.controls['menu'].value),
                'menuURL': _this.commonService.removeSpaceMaoreThanOne(_this.mainMenuForm.controls['menu_url'].value),
                'statusid': null,
                'createdBy': null,
                'modifiedBy': null,
                'menuColor': null,
                'menuIcon': null,
            }).subscribe(function (duplicateMenu) {
                if (duplicateMenu) {
            ...
            }, function () { resolve({ 'duplicateMenuName': true }); });
        });
        return q;
    };
    ...
    MainMenuComponent.prototype.onFormValuesChanged = function () {
        for (var field in this.formErrors) {
            ...
            // Get the control
            var control = this.mainMenuForm.get(field);
    ...
    //On form submit
    MainMenuComponent.prototype.onMainMenuFormSubmit = function () {
        var _this = this;
        var var_id = this.mainMenuForm.value.id;
        var var_menu = this.mainMenuForm.value.menu;
        var var_menu_url = this.mainMenuForm.value.menu_url;
        ...
        if (this.title == "Save") { // on create menu form submit
            ...
            this._meinMenuService.saveMainMenu({
                ...
                _this.commonService.showAlertMessage('Menu Added Successfully.');
            ...
            this._meinMenuService.updateMainMenu({
                ...
                .subscribe(function (data) {
                _this.commonService.showAlertMessage('Menu Updated Successfully.');
                _this.title = "Save";
                _this.getGrid();
                _this.mainMenuForm.reset();
            }, function (error) {
    ...
    MainMenuComponent.prototype.applyFilter = function (filterValue) {
        filterValue = filterValue.trim(); // Remove whitespace
        filterValue = filterValue.toLowerCase(); // Datasource defaults to lowercase matches
        this.dataSource.filter = filterValue;
    };
    MainMenuComponent.prototype.AddMenu = function () {
        this.menuForm = true;
    };
    // Update Main Menu
    MainMenuComponent.prototype.updateMainmenu = function (id) {
        this.menuForm = true;
        this.spinnerService.show();
    ...
    MainMenuComponent.prototype.onGoBack = function () {
        this.mainMenuForm.reset();
        this.menuForm = false;
    };
    // Delete main Menu.
    MainMenuComponent.prototype.deleteMainmenu = function (id) {
        var _this = this;
        this._meinMenuService.deleteMainMenu(id)
            .subscribe(function (data) {
            _this.commonService.showAlertMessage('Menu Deleted Successfully.');
            _this.getGrid();
            _this.mainMenuForm.reset();
            _this.status = true;
            ...
            _this.formErrors = error;
            _this.commonService.showAlertMessage(_this.formErrors);
            _this.spinnerService.hide();
        });
    };
    MainMenuComponent.prototype.getGrid = function () {
        var _this = this;
        this.menuForm = false;
        this._meinMenuService.getMainMenu().subscribe(function (data) {
            _this.data = [];
            _this.users = [];
            _this.data = data;
            for (var i = 0; i < _this.data.length; i++) {
                _this.data[i].sno = i + 1;
...
/* harmony import */ var _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @angular/material/button-toggle */ "./node_modules/@angular/material/esm5/button-toggle.es5.js");
...
var MainMenuService = /** @class */ (function () {
    function MainMenuService(_http) {
        this._http = _http;
...
//# sourceMappingURL=components-masters-menu-main-menu-module-ngfactory-es5.js.map