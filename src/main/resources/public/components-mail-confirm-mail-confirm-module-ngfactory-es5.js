...
var MailConfirmComponent = /** @class */ (function () {
    function MailConfirmComponent(fb, authService, router, formBuilder, spinnerService, authenticationService, alertService, route) {
        this.fb = fb;
    ...
    MailConfirmComponent.prototype.ngOnInit = function () {
    ...
    MailConfirmComponent.prototype.createForms = function () {
        ...
        var phone = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', {
    ...
    MailConfirmComponent.prototype.onSubmitAccountDetails = function (value) {
        var _this = this;
        console.log(value);
        //this.router.navigate(['/dashboard']);
        this.spinnerService.show();
        var email = this.accountDetailsForm.value.email;
        var password = this.accountDetailsForm.value.password;
        console.log(email + " : " + password);
        console.log("this.loginForm: " + (this.accountDetailsForm));
        // return false;
        this.authenticationService.login(email, password)
            .subscribe(function (data) {
            _this.authenticationService.getLoginUserData(email, password)
    ...
    MailConfirmComponent.prototype.onSubmitUserDetails = function (value) {
        console.log(value);
    };
...
//# sourceMappingURL=components-mail-confirm-mail-confirm-module-ngfactory-es5.js.map