 ...
 * tslint:disable
 */ 
var styles = ["table[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.filter[_ngcontent-%COMP%] {\n  font-size: 14px;\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
...
var RoleTypeComponent = /** @class */ (function () {
    function RoleTypeComponent(_roleTypemaster, formBuilder, _router, router, actRoute, dialog, spinnerService, commonService) {
    ...
    RoleTypeComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.RoleType.valueChanges.subscribe(function () {
            _this.onFormValuesChanged();
        });
        this.getRoleTypeData();
    };
    RoleTypeComponent.prototype.RoleEditAction = function (id) {
        var _this = this;
        this.addRole = true;
        this._roleTypemaster.getRoledata(id).subscribe(function (resp) {
            _this.cloneupdate = false;
            _this.updatedata = false;
            _this.saveRole = false;
            // this.addRole =false;    
            _this.responseStatus = resp;
            _this.RoleType.patchValue({
                id: _this.responseStatus.id,
                roles: _this.responseStatus.roleType,
            });
        }, function (error) { return _this.roleTypeErrors = error; });
        this.commonService.scrollTop("forms");
    };
    RoleTypeComponent.prototype.getRoleTypeData = function () {
        var _this = this;
        var roles = [];
        this._roleTypemaster.getRoleList().subscribe(function (data) {
    ...
    RoleTypeComponent.prototype.onFormValuesChanged = function () {
        for (var field in this.roleTypeErrors) {
            ...
            // Get the control
            var control = this.RoleType.get(field);
            if (control && control.dirty && !control.valid) {
                this.roleTypeErrors[field] = control.errors;
            }
        }
    };
    RoleTypeComponent.prototype.onRoleTypeSubmit = function () {
        var _this = this;
        var var_id = this.RoleType.value.id;
        var var_role = this.RoleType.value.role;
        var var_roles = this.RoleType.value.roles;
        ...
        if (this.title == "Save") { // on create menu form submit      
            ...
            this._roleTypemaster.addMroleType({
                ...
                _this.data = data;
                _this.commonService.showAlertMessage("Role Saved Successfully");
                var temObj = 0;
                if (_this.saveRole == true) {
                    temObj = 1;
                }
                ...
                _this.RoleType.reset();
                _this.addRole = false;
            }, function (error) { return function (error) {
                _this.roleTypeErrors = error;
                _this.commonService.showAlertMessage(_this.roleTypeErrors);
                _this.spinnerService.hide();
            }; });
        }
            ...
            this._roleTypemaster.editMroleType({
                ...
                .subscribe(function (data) {
                _this.commonService.showAlertMessage("Role Updated Successfully");
                _this.title = "Save";
                _this.getRoleTypeData();
                _this.saveRole = false;
    ...
    RoleTypeComponent.prototype.duplicateRoletype = function () {
        var _this = this;
        var q = new Promise(function (resolve, reject) {
            var role = _this.RoleType.controls['roles'].value;
            var filter = !!_this.rolesList && _this.rolesList.filter(function (roles) {
                return roles.roleType.toLowerCase() == role.trim().toLowerCase();
            });
            if (filter.length > 0) {
                resolve({ 'duplicateRoletype': true });
            }
            _this._roleTypemaster.duplicateRoletype({
                'modifiedBy': null,
                'createdBy': null,
                'roleType': _this.RoleType.controls['roles'].value,
                'id': null,
                'role': null
            ...
            }, function () { resolve({ 'duplicateRoletype': true }); });
        });
        return q;
    };
    RoleTypeComponent.prototype.AddRole = function () {
        var _this = this;
        this.spinnerService.show();
        this._roleTypemaster.getMasterRoleList().subscribe(function (response) {
            _this.availableRolesList = response;
            var list = _this.availableRolesList;
            var _loop_1 = function (i) {
                var flag = _this.rolesList.find(function (val) {
                    return val.roleType == list[i].roleName;
                });
                console.log(flag + " : " + list[i].roleName);
                if (!flag) {
                    _this.availableRolesList.splice(_this.availableRolesList.indexOf(list[i].roleName), 1);
                }
            };
    ...
    RoleTypeComponent.prototype.onGoBack = function () {
        this.RoleType.reset();
        this.saveRole = false;
        this.cloneupdate = true;
        this.addRole = false;
    ...
    RoleTypeComponent.prototype.applyFilter = function (filterValue) {
        filterValue = filterValue.trim();
        filterValue = filterValue.toLowerCase();
        this.dataSource.filter = filterValue;
    };
    RoleTypeComponent.prototype.deleteRole = function (id) {
        var _this = this;
        ...
        this.confirmDialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                ...
                _this._roleTypemaster.deleteRole(id)
                    .subscribe(function (data) {
                    _this.commonService.showAlertMessage('Role Deleted Successfully.');
                    _this.getRoleTypeData();
                }, function (error) {
                    _this.roleTypeErrors = error;
                    _this.commonService.showAlertMessage(error.statusText);
    ...
    RoleTypeComponent.prototype.editRoleType = function (ID) {
        this.spinnerService.show();
        this.addRole = true;
...
var RoleTypeModule = /** @class */ (function () {
    function RoleTypeModule() {
    }
...
//# sourceMappingURL=components-masters-role-type-role-type-module-ngfactory-es5.js.map