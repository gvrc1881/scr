...
@Component({
  selector: 'app-add-approve-special-works',
  templateUrl: './add-approve-special-works.component.html',
  providers: [
    {
...
export class AddApproveSpecialWorksComponent implements OnInit {
