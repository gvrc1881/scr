...
import { ApprovePsiThermovisionMeasuresComponent } from './approve-psi-thermovision-measures.component';
...
const routes: Routes = [
    {
        path:'',
        component: ApprovePsiThermovisionMeasuresComponent,
    }
]

@NgModule({
    declarations: [
        ApprovePsiThermovisionMeasuresComponent
    ],
    imports: [
...
export class ApprovePsiThermovisionMeasuresModule{
