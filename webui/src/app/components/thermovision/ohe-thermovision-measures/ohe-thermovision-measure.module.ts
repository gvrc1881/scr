...
import { OheThermovisionMeasureComponent } from './ohe-thermovision-measure.component';
...
const routes: Routes = [
    {
        path:'',
        component: OheThermovisionMeasureComponent,
    }
]

@NgModule({
    declarations: [
        OheThermovisionMeasureComponent
    ],
    imports: [
...
export class OheThermovisionMeasureModule{
