...
import { ApproveOheThermovisionMeasuresComponent } from './approve-ohe-thermovision-measures.component';
...
const routes: Routes = [
    {
        path:'',
        component: ApproveOheThermovisionMeasuresComponent,
    }
]

@NgModule({
    declarations: [
        ApproveOheThermovisionMeasuresComponent
    ],
    imports: [
...
export class ApproveOheThermovisionMeasuresModule{
