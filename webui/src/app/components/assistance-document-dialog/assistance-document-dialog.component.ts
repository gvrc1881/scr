...
@Component({
    selector: 'assistance-document-view-dialog',
    templateUrl: './assistance-document-dialog.component.html',
})
export class AssistanceDocumentComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<AssistanceDocumentComponent>,
