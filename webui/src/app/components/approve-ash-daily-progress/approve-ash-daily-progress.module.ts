...
import { ApproveAshDailyProgressComponent } from './approve-ash-daily-progress.component';
...
const routes: Routes = [
    {
        path:'',
        component: ApproveAshDailyProgressComponent,
    }
]

@NgModule({
    declarations: [
        ApproveAshDailyProgressComponent
    ],
    imports: [
...
export class ApproveAshDailyProgressModule{
