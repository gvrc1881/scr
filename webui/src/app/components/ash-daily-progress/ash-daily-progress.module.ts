...
import { AshDailyProgressComponent } from './ash-daily-progress.component';
...
const routes: Routes = [
    {
        path:'',
        component: AshDailyProgressComponent,
    }
]

@NgModule({
    declarations: [
        AshDailyProgressComponent
    ],
    imports: [
...
export class AshDailyProgressModule{
