export const FieldLabelsConstant = {
   LABELS: {
      ATD_AOH:"Atd-Aoh",
       ...
       MCL_POH:"Mcl-Poh",
       ALREADY_DONE_APPROVE:"Already Done (Approve)",
   ...
   TITLE:{
     ...
     PRODUCT_CATEGORY_FORM:'Product Category ',
     PRODUCT_CATEGORY_MEMBER_FORM:'Product Category Member ',
     STANDARD_PHASES_DATA:'Standard Phases Data',
     STANDARD_PHASES_FORM:'Standard Phases ',
     STANDARD_PHASE_ACTIVITY_DATA:'Standard Phase Activity Data',
     STANDARD_PHASE_ACTIVITY_FORM:'Standard Phase Activity ',
     GRID_FAILURE:'GRID Failure',
     GROUPS_SECTIONS:'Groups Sections',
     CB_FAILURES:'CB Tripping',
     RC_Failures:'RC Failures',
     RC_FAILURES_FORM:'Rc Failure ',
     FAILURE_OCCURENCE:'Failure Occurence',
     FAILURE_OCCURRENCE_FORM:'Failure Occurence ',
     UNUSUAL_OCCURRENCE:'Unusual Occurence ',
     UNUSUAL_OCCURRENCE_FAILURE_FORM:'Unusual Occurrence Failure ',
     ACTIONS_FORM:'Actions',
     CB_FAILURE_FORM:'CB Tripping',
     GRID_FAILURE_FORM:'GRID FAILURE',
     ...
     ASSETS_SCHEDULE_FORM:'Assets schedule',
     DRIVES:'DRIVES',
     DRIVE_FORM:'Drive',
     DRIVE_CATEGORY_FORM:'Drive Category',
     CHECK_LIST_FORM:'Check List',
     DRIVE_DAILY_PROGRESS_FORM:'Drive Daily Progress',
     STIPULATION_FORM:'Stipulation',
     INSPECTION_FORM:'Inspection',
     ASSET_MASTER_DATA:'Asset Master Data',
     ASSET_MASTER_DATA_FORM:'Asset Master Data',
     ELECTRIFICATION_TARGETS_FORM:'Electrification Targets',
     GUIDANCE:'Guidance',
     SIDINGS_ITEM:'Sidings Item',
     SIDINGS_DATA:'Sidings Data',
     TRACK:'Track',
     OHE_LOCATIONS_DATA:'Ohe Locations Data',
     OHE_LOCATION_FORM:'Ohe Location',
     GANTRY_FORM:'Gantry',
     GANTRY_DATA: 'Gantry Data',
     SECTOR_FORM:'Sector',
     SECTOR_DATA: 'Sector Data',
     SUB_SECTOR_FORM:'Sub Sector',
     SUB_SECTOR_DATA: 'Sub Sector Data',
     ELEMENTARY_SECTIONS_FORM:'Elementary Sections',
     ...
     DRIVE_CATEGORY_ASSOCIATION_FORM:'Drive Category Association',
     SIDING_FORM:'Sidings',
     WORK:'Work',
     SWITCH_OPERATIONS:'Switch Operations',
     OBSERVATION_CATEGORIES_DATA:'Observation Categories Data',
     OBSERVATIONS_FORM:'OBSERVATIONS',
    FAILURE_ANALYSIS_FORM:'Failure Analysis',
    OBSERVATION_CATEGORY:'Observation Category',
    PROJECT:'Project',
